...
# --- CLOUD FUNCTION ENTRY POINT FOR FIRST_VISIT ---
@functions_framework.http
def first_visit_function(request): # Renamed function to first_visit_function
    ...
    if request.method == 'POST':
        ...
        # --- TIMESTAMP FORMATTING MODIFICATION START ---
        try:
            # Parse client timestamp (e.g., '2025-07-28T10:09:25.241585Z')
            ...
            # Remove timezone info and format explicitly
        ...
        # --- TIMESTAMP FORMATTING MODIFICATION END ---
